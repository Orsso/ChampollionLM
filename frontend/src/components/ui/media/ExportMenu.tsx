          ...
          {options.map((option, index) => {
            ...
            return (
              <button
                ...
                className={`w-full px-4 py-3 text-left text-sm font-bold flex items-center gap-3 text-white relative group transition-all ${TRANSITIONS.fast} ${
                  isNotLast ? `${BRUTAL_BORDERS.thin} border-b-black` : ''
