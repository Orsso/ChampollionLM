...
export function FloatingActionButton({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className={`fixed bottom-6 right-6 md:bottom-10 md:right-10 z-40 inline-flex items-center gap-3 ${RADIUS.normal} bg-orange-500 hover:bg-orange-600 text-white ${BORDERS.thick} border-black ${SHADOWS.large} px-5 py-4 transition-all ${TRANSITIONS.fast} hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-200 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-900 font-bold ${className}`}
